...
FORM_REGISTRY: dict[str, type] = {
    ...
    "form_122a1_supp": Form122A1SuppGenerator,
    "form_122a2": Form122A2Generator,
    "form_122b": Form122BGenerator,
    ...
    "schedule_g": ScheduleGGenerator,
    "schedule_h": ScheduleHGenerator,
