        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "creditor_name",
                    models.CharField(
                        help_text="Name of creditor or collection agency",
                        max_length=255,
                    ),
                ),
                (
                ...
                (
                    "amount_owed",
                    apps.intake.fields.EncryptedDecimalField(
                        decimal_places=2,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Has this account been sent to collections?",
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True,
                        help_text="Additional context about this amount owed",
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, help_text="Bank or institution name", max_length=100
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
