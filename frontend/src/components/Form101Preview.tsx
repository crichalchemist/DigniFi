  ...
  return (
    <div className="border rounded-md p-6 bg-white shadow-sm">
      ...
      <p className="mb-6 text-gray-600">
        Based on the information you've provided, we can generate your Voluntary Petition for
        Individuals Filing for Bankruptcy. You can preview this form to see how your information
